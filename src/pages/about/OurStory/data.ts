...
export const OUR_STORY_DATA = {
  ...
  description:
    "Thursday was built out of our own frustration. Clunky work boots or delicate fashion boots? Cheap shoes that fall apart after a few wears, or shoes that were incredibly overpriced? It didn’t seem right that we had to make these trade-offs. There had to be another option.",
  features: [
    {
      id: 0,
      img: OurStory1,
